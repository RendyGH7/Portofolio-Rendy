          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <button 
                ...
                className="group relative px-6 py-3 bg-gradient-to-r from-purple-600 via-pink-600 to-cyan-600 text-white font-semibold rounded-full hover:from-purple-900 hover:via-pink-900 hover:to-cyan-900 transition-all duration-300 hover:scale-105 transform overflow-hidden outline-none focus:outline-none"
              >
                ...
                {/* Animated background */}
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 opacity-0 group-hover:opacity-30 transition-opacity duration-300"></div>
              </button>
            </div>
